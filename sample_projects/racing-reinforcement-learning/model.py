...
# The action table — every step the model picks one of these.
# Edit freely — add actions, change values.
# (hardware limits: |steering| <= 20 deg, speed <= 3.0 m/s)
ACTIONS = [
    {"speed": 0.5, "steering": 20.0},    # left
    {"speed": 0.5, "steering": 0.0},     # straight
    {"speed": 0.5, "steering": -20.0},   # right
]

CAMERA_W, CAMERA_H = 160, 120   # model input resolution (camera is 480x360)
CAMERA_PAN, CAMERA_TILT = 0.0, -15.0   # camera angle (deg) — training
