...
git clone https://github.com/physicar-ai/physicar-python.git .devcontainer/physicar-python
...
# PhysiCar Chat instructions: copy the workspace instructions to the home-level
# fallback path (~/.physicar/chat-instructions.md)
mkdir -p ~/.physicar
cp -f ~/physicar_ws/.physicar/chat-instructions.md ~/.physicar/chat-instructions.md
