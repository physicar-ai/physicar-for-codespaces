...
# eval_time: DR_LOCAL_S3_EVAL_PARAMS_FILE에서 추출하거나 새로 생성
# 예: "evaluation/20260125063728/evaluation_params.yaml" -> "20260125063728"
...
# Modified for physicar: DR_LOCAL_S3_EVAL_PARAMS_FILE이 경로 포함시 그대로 사용
if '/' in s3_yaml_name:
    # 이미 상대경로 포함 (예: evaluation/20260125/evaluation_params.yaml)
    yaml_key = os.path.normpath(os.path.join(s3_prefix, s3_yaml_name))
else:
    # 기본 파일명만 (예: evaluation_params.yaml) - 기존 방식
